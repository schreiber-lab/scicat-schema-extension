...
const propTypes = {
  ...
  viewRef: T.oneOfType([T.func, T.shape({ current: T.instanceOf(Element) })]),
};
    ...
    return (
      <RCS
        ...
        renderTrackHorizontal={(props) => (
          <div
            {...props}
            className={cn(classes.track, classes.track_horizontal)}
          />
        )}
        renderTrackVertical={(props) => (
          <div
            {...props}
            className={cn(classes.track, classes.track_vertical)}
          />
        )}
